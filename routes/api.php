...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::post('updateCommunication', [ClientCommunicationController::class, 'updateCommunication']);
    ...
    Route::post('addDateInstall', [ClientsDateController::class, 'addDateInstall']);
    ...
    Route::post('/updateInvoice/{invoice_id}', [FilesInvoiceController::class, 'updateInvoice']);
